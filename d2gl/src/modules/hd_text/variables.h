...
inline const std::map<uint32_t, D2SampleText> g_sample_text = {
	{ LANG_ENG, {
		L"Single line text ABCDWXYZ 0123456789 SymbolSⒶⒷⒸⒹ☩☪☫☬☭☮☯☸☹➀➁➂123",
	...
	{ LANG_JPN, {
		L"単一行のテキスト ABCDWXYZ 0123456789 記号ⒶⒷⒸⒹ☩☪☫☬☭☮☯☸☹➀➁➂123",
